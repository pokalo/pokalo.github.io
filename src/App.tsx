const expertise = [
  ...
  },
  {
    ...
    items: ['Nginx, Apache', 'Postfix, Exim', 'Высоконагруженные системы', 'Веб-серверы и прокси'],
  },
  {
    area: 'Базы данных',
    items: ['MySQL', 'PostgreSQL', 'MongoDB', 'Проектирование БД'],
  },
  {
  ...
  {
    area: 'Тестирование ПО',
    items: ['Модульное тестирование', 'Интеграционное тестирование', 'Нагрузочное тестирование', 'Автоматизация тестов'],
  },
]
      ...
      <section id="team" className="border-t border-white/5 px-6 py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mx-auto mb-12 max-w-2xl text-center text-zinc-400 leading-relaxed">
            <p className="mb-4">
              PAVKRAFT Labs — команда разработчиков с серьёзным стажем
              и опытом в развёртывании и сопровождении крупных проектов.
            </p>
            <p className="mb-4">
